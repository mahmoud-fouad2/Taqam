      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">{t.trainingEnrollments.enrollment}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">
              {t.trainingEnrollments.enrollmentRequest}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {t.trainingEnrollments.inTraining}
            </CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">
              {t.trainingEnrollments.currentlyTraining}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {t.trainingCourses.completedTraining}
            </CardTitle>
            <IconCertificate className="h-4 w-4 text-green-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{stats.completed}</div>
            <p className="text-muted-foreground text-xs">{t.trainingEnrollments.trainee}</p>
          </CardContent>
        </Card>
      </div>
