...
const releaseHighlights = [
  {
    ...
    summaryAr:
      "المسار التشغيلي الحالي يعتمد على تحقق كامل قبل الإطلاق ومسار بناء متوافق محليًا وعلى Render.",
    summaryEn:
      "The current release path uses full validation before shipping and a build flow that works locally and on Render.",
    itemsAr: [
  ...
  },
  {
    ...
    summaryAr:
      "الإجراءات الأساسية التي كانت محاكاة فقط أصبحت تتعامل مع الـ APIs الحقيقية وتنعكس على البيانات مباشرة.",
    summaryEn:
      "Core operations that previously stopped at UI simulation now execute against the live APIs and persist real data.",
    itemsAr: [
  ...
  },
  {
    ...
    summaryAr:
      "الواجهات الإدارية الحالية تعرض بيانات حقيقية من النظام بدل النصوص المؤقتة أو السجلات المصطنعة.",
    summaryEn:
      "Current admin screens now surface real system data instead of temporary copy or fabricated activity entries.",
    itemsAr: [
...
export default async function WhatsNewPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-start text-2xl font-bold">{t.common.whatsNew}</h1>
