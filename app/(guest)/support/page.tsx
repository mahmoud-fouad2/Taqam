...
const supportChannels = [
  ...
  },
  {
    ...
    descAr:
      "الأحد – الخميس: 9:00 ص – 6:00 م بتوقيت السعودية. إذا أرسلت خارج ساعات العمل، سيتولى الفريق المتابعة في أول نافذة تشغيل متاحة.",
    descEn:
      "Sunday – Thursday: 9:00 AM – 6:00 PM KSA time. If you send outside working hours, the team will follow up in the next available window."
  },
  {
    icon: Shield,
    ...
    descAr:
      "راجع مركز المساعدة للأساسيات، والـ FAQ للأسئلة المتكررة، ثم استخدم هذه الصفحة للمشكلات الفعلية.",
    descEn:
      "Check the help center for basics and the FAQ for common questions, then use this page for real incidents."
  }
];
    ...
    <FadeIn direction="up">
      <main className="bg-background">
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="text-center lg:text-start">
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-3 lg:justify-start">
                  <div className="border-border/50 bg-muted/30 flex items-center gap-2 rounded-full border px-4 py-2 text-sm backdrop-blur-sm">
                  ...
                  <div className="border-border/50 bg-muted/30 flex items-center gap-2 rounded-full border px-4 py-2 text-sm backdrop-blur-sm">
                    ...
                    <span className="text-muted-foreground">
                      {isAr ? "الأحد - الخميس • 9-6" : "Sun-Thu • 9-6 KSA"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative mx-auto hidden w-full max-w-sm lg:block">
                ...
                <div className="dark:bg-card/90 relative overflow-hidden rounded-[2.5rem] rounded-tl-[6rem] rounded-br-[6rem] border-[6px] border-white/60 bg-white/90 shadow-2xl dark:border-white/10">
                ...
                {/* Floating badge */}
                <div className="dark:bg-card/95 absolute -start-8 top-16 rounded-2xl border border-white/60 bg-white/95 p-3.5 shadow-xl backdrop-blur-md dark:border-white/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-foreground text-sm font-bold">
                        {isAr ? "فريق خبراء متاح" : "Expert team available"}
                      </p>
                      <p className="text-muted-foreground text-xs font-medium">
                        {isAr ? "رد سريع خلال 24 ساعة" : "Quick reply within 24h"}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4">
            {highlightedIssue ? (
              <div className="border-primary/20 bg-primary/5 text-foreground/85 mb-10 rounded-[2rem] border px-6 py-5 text-sm leading-7">
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
              {/* Form */}
              <div className="border-border/50 bg-card/90 rounded-[2.5rem] border p-8 shadow-sm backdrop-blur-sm sm:p-10">
                <div className="mb-8">
              ...
              <div className="space-y-5">
                {supportChannels.map((channel) => {
                  ...
                  return (
                    <div
                      key={channel.titleEn}
                      className="group border-border/40 bg-card/60 hover:border-border/80 hover:bg-card/95 relative overflow-hidden rounded-[2.5rem] border p-8 shadow-sm backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:shadow-xl">
                      <div
                        className={`mb-5 flex h-14 w-14 items-center justify-center rounded-[1.25rem] bg-gradient-to-br shadow-inner ${channel.color}`}>
                      ...
                      {channel.icon === Mail && (
                        <a
                          ...
                          className="border-border/60 bg-background/80 text-foreground hover:bg-muted mt-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition duration-300 hover:scale-105">
