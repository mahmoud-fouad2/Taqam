...
const styles = StyleSheet.create({
  ...
  chipText: { color: "#64748b", fontWeight: "700", fontSize: 11 },
  chipTextActive: { color: "#3b82f6" },
  errorText: { color: "#ef4444", paddingHorizontal: 16, marginVertical: 6, fontSize: 13 },
  ...
  typeTagText: { color: "#6366f1", fontSize: 12, fontWeight: "700" },
  statusTag: {
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 8,
  ...
  cardTitle: { color: "#0f172a", fontSize: 15, fontWeight: "700", marginBottom: 5 },
  ...
  fieldLabel: { color: "#64748b", fontSize: 13, fontWeight: "600" },
  // Choice cards
  choiceCard: {
    flexDirection: "row",
    alignItems: "center",
  ...
  choiceText: { flex: 1 },
  choiceTitle: { color: "#0f172a", fontSize: 16, fontWeight: "700" },
  choiceSub: { color: "#94a3b8", fontSize: 12, marginTop: 2 },
  choiceArrow: { color: "#cbd5e1", fontSize: 22 },
  // Leave types
  leaveTypeChip: {
  ...
  leaveTypeText: { color: "#334155", fontWeight: "700", fontSize: 13 },
  unpaidTag: { color: "#94a3b8", fontSize: 10, marginTop: 2, fontWeight: "600" },
  noTypesText: { color: "#94a3b8", fontSize: 14, marginVertical: 8 },
  // Date
  datePressable: {
    flexDirection: "row",
    alignItems: "center",
  ...
  successText: { color: "#16a34a", fontSize: 16, fontWeight: "700" },
